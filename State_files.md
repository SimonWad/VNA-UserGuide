...
1. 2-way calibrated SOLT (Highly recommended)

## 1. 2-way calibrated start

To start your work with the VNA, push the **9: Save/Recall** button &rarr; press **recall** on the screen select buttons &rarr; Navigate to **2-way_SOLT.sta** &rarr; press **recall** on the screen select buttons.
...
To save your state, push the **9: Save/Recall** button &rarr; press **File Type** on the screen select buttons and select **state** &rarr; press **save** &rarr; Add your SDU ID (Please note that it should be whatever is before the @ in your University mail)

> Example: user is USER@sdu.dk.
>
> pres **save** &rarr; 2026-01-12.15_32_57_USER.sta
